...
Le code source complet d'Odoo 17 (version utilisée par cette instance) est cloné à côté de ce dépôt ; chemins relatifs à la racine du dépôt, selon le poste :

| Poste | Odoo Community (core) | Modules Enterprise (dont `web_studio`) |
| --- | --- | --- |
| VPS de développement (Linux) | `../odoo17/odoo` | `../odoo17/enterprise` |
| Poste Windows | `../odoo_17/odoo17` | `../odoo_17/enterprise` |

Les chemins `D:\git\odoo_17` cités dans les documents existants correspondent à `../odoo_17` sur le poste Windows.
