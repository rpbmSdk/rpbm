...
2. Formaliser les champs `x_studio_*` en modèle/vue versionnés du module (ou script d'installation idempotent), pour rendre la configuration métier reproductible entre instances.
