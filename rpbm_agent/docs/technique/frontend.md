...
explicitement son libellé. Le bouton « Voir les accessoires compatibles » contrôle leur
affichage. Cliquer de nouveau sur cette pièce la désélectionne et efface les données qui en
dépendent (pièce après-marché, eurocode, résultats et article VSF).
